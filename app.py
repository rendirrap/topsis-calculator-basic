...
# =================================================================
# 1. KONFIGURASI HALAMAN UTAMA (Menggunakan 'wide' agar fleksibel)
# =================================================================
st.set_page_config(
    page_title="Multi-Function Responsive Suite",
    page_icon="📊",
    layout="wide"
)

# =================================================================
# 2. GABUNGAN ADVANCED & CUSTOM CSS (GLOBAL & SPESIFIK)
# =================================================================
st.markdown("""
    <style>
    /* --- GLOBAL STYLES --- */
    ...
    /* --- MATERIAL DESIGN CARD ELEVATION (TOPSIS) --- */
    .material-card {
    ...
    /* Modifikasi Tombol di Tab Kalkulator Standar */
    div.calc-container div.stButton > button {
        width: 100% !important;
    ...
    div.calc-container div.stButton > button[key^="btn_op_"], 
    div.calc-container div.stButton > button[key="btn_sama_dengan"] {
        background-color: #D97706 !important;
        color: white !important;
        border: none !important;
    }
    div.calc-container div.stButton > button[key^="btn_op_"]:hover, 
    div.calc-container div.stButton > button[key="btn_sama_dengan"]:hover {
        background-color: #F59E0B !important;
    }
    /* Warna khusus tombol Clear / Reset (Merah) */
    div.calc-container div.stButton > button[key="btn_clear"] {
        background-color: #DC2626 !important;
        color: white !important;
        border: none !important;
    }
    div.calc-container div.stButton > button[key="btn_clear"]:hover {
    ...
    @media (max-width: 640px) {
        ...
        /* Penyesuaian Tombol Kalkulator di HP */
        div.calc-container div.stButton > button {
...
<div class="navbar-navy">
    <h3 style='margin:0; font-weight:600; color:white; font-size:22px;'>📊 Multi-Function Analytics Suite</h3>
...
# =================================================================
# 3. INITIALIZATION STATE MANAGEMENT (GABUNGAN)
# =================================================================
# State untuk TOPSIS
...
# State untuk Kalkulator Standar
...
# =================================================================
# 4. FUNGSI LOGIKA (GABUNGAN)
# =================================================================
# Fungsi Logika TOPSIS Core
...
# Fungsi Logika Kalkulator Standar
def press_key(key):
...
# =================================================================
# 5. PEMBUATAN INTERFACES MENGGUNAKAN TABS
# =================================================================
tab_topsis, tab_calc = st.tabs(["📊 TOPSIS Decision Calculator", "🧮 Standard Online Calculator"])

# -----------------------------------------------------------------
# TAB 1: TOPSIS CALCULATOR INTERFACE
# -----------------------------------------------------------------
with tab_topsis:
    ...
    with col_panel_left:
        ...
        if st.button("➕ Tambah Kriteria", type="secondary", use_container_width="always", key="add_crit_btn"):
    ...
    with col_panel_right:
        ...
        if st.button("➕ Tambah Alternatif", type="secondary", use_container_width="always", key="add_alt_btn"):
    ...
    # --- EKSEKUSI TOPSIS ---
    btn_compute = st.button("🚀 HITUNG SEKARANG", use_container_width="always", type="primary", key="compute_topsis")
    ...
    if btn_compute:
        ...
        # Tabel Hasil Akhir dengan Highlight Warna
...
# -----------------------------------------------------------------
# TAB 2: REPLIKA ONLINE CALCULATOR INTERFACE
# -----------------------------------------------------------------
with tab_calc:
    st.write("")
    st.markdown("<h4 style='text-align: center; color: #1F2937;'>🧮 The Online Calculator Replica</h4>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; font-size:13px; color: #6B7280; margin-bottom:20px;'>Desain grid kompak adaptif yang disesuaikan untuk kenyamanan ketukan jari di HP.</p>", unsafe_allow_html=True)
    
    # Mulai kontainer utama kalkulator standar
    st.markdown('<div class="calc-container">', unsafe_allow_html=True)
    
    # Layar Tampilan Angka Digital
    st.markdown(f'<div class="calc-display">{st.session_state.display_val}</div>', unsafe_allow_html=True)
    
    # Struktur Grid Tombol (4 Kolom)
